...
import 'package:uc_trans_web_portal/authentication/login_screen.dart';
import 'package:uc_trans_web_portal/users/all_verified_users_screen.dart';
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton.icon(
                  icon: const Icon(Icons.person_add, color: Colors.white,),
                  label: Text(
                    "All Verified Drivers".toUpperCase() + "\n" + "Accounts".toUpperCase(),
                    style: const TextStyle(
                      fontSize: 16,
                      color: Colors.white,
                      letterSpacing: 3,
